...
#Modificación
//Si queremos que un numero se muestre de la siguiente forma: 39##########
$code = 39;
//Vamos a tener 8 espacio con 8 carácteres
echo "<br>";
echo str_pad($code, 8, '#'); //resultado: 39###### (hasta 8 caracteres)
echo "<br>";

//Ambos lados, izquierda y derecha
echo str_pad($code, 8, '#', STR_PAD_BOTH); // resultado: ###39###
echo "<br>";
echo str_pad($code, 8, '#', STR_PAD_LEFT); // resultado: ######39
echo "<br>";
echo str_pad($code, 8, '#', STR_PAD_RIGHT); // resultado: 39###### (la forma por defecto)
echo "<br><br>";
...
echo strtoupper($text_uno);//monobyte --> resultado: PHP ES UN LENGUAJE; AñO 2020, PROGRAMACIóN (tanto al ñ como la ó salen en minuscula)
echo "<br>";
//Al colocar mb_nombrefuncion con esto formateamos correctamente.
echo mb_strtoupper($text_dos);//multibyte --> resultado añadiendo mb_: PHP ES UN LENGUAJE; AÑO 2020, PROGRAMACIÓN